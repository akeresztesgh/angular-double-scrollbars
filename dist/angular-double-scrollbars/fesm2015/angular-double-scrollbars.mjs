...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AngularDoubleScrollbarsService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
/** @nocollapse */ AngularDoubleScrollbarsComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: AngularDoubleScrollbarsComponent, selectors: [["lib-angular-double-scrollbars"]], viewQuery: function AngularDoubleScrollbarsComponent_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, inputs: { doubleScrollBarHorizontal: "doubleScrollBarHorizontal" }, ngContentSelectors: _c6, decls: 7, vars: 14, consts: [[2, "overflow-y", "hidden", 3, "ngStyle"], [2, "overflow-y", "hidden", "position", "relative", "top", "-1px", 3, "ngStyle", "scroll"], ["wrapperDiv", ""], [3, "ngStyle"], [3, "ngStyle", "scroll"], ["mainDiv", ""]], template: function AngularDoubleScrollbarsComponent_Template(rf, ctx) {
        if (rf & 1) {
            i0.ɵɵprojectionDef();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AngularDoubleScrollbarsComponent, [{
            type: Component,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AngularDoubleScrollbarsModule, [{
            type: NgModule,
            args: [{
